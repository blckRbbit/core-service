package com.shary.coreapi.util.exception.handler;

import com.shary.coreapi.util.exception.*;
import com.shary.coreapi.util.exception.error.ApplicationError;
import com.shary.coreapi.util.exception.error.FieldsValidationError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<FieldsValidationError> catchIllegalArgumentException(
        ...
        log.error(String.valueOf(e));
        e.printStackTrace();
        List<String> errorMessages = new java.util.ArrayList<>(List.of(e.getMessage()));
        return new ResponseEntity<>(new FieldsValidationError(errorMessages), HttpStatus.BAD_REQUEST);
    }
